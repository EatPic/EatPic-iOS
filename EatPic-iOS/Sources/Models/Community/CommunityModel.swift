...
let sampleUsers: [CommunityUser] = [
    CommunityUser(id: "전체", nickname: "전체",
                  profileImage: Image("Community/grid_selected"), isCurrentUser: false),
    CommunityUser(id: "나", nickname: "나", profileImage: nil, isCurrentUser: true),
    CommunityUser(id: "id1", nickname: "아이디1", profileImage: nil, isCurrentUser: false),
    CommunityUser(id: "id2", nickname: "아이디2", profileImage: nil, isCurrentUser: false),
    CommunityUser(id: "id3", nickname: "아이디3", profileImage: nil, isCurrentUser: false)
]
